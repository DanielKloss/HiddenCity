...
.controller('controller', ['$cookies', function ($cookies) {
    ...
    self.hints = [
        ...
        {
            number: 6,
            hint: "There is a menu outside The Village Inn. But they've changed the menu! The answer is 13 pounds.",
        },
        {
            number: 7,
